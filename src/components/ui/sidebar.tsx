...
function Sidebar({
  ...
  // Extract data-testid to pass to mobile sheet content
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          data-testid={dataTestId || 'mobile-nav-drawer'}
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden !duration-0 data-[state=closed]:!duration-0"
          style={
            {
...
function SidebarMenuSkeleton({
  ...
  // Deterministic width based on component instance (avoids hydration mismatch)
  const width = '70%';
